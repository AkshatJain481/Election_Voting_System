...
<>  <div className='bg-[#000000] max-w-[400px] h-[400px] rounded-3xl mx-auto mt-[8%]'>
          <form class="flex flex-col " onSubmit={handleSubmit}>
            <div className='mx-auto mt-[25px]'>
              <label class="font-montser5at text-[20px]  text-white font-bold mt-[15px] flex items-start mb-[15px]" htmlFor="email">Email</label>
              <input class="font-montserrat placeholder:text-white bg-white bg-opacity-25 border-white focus:border-white
    ...
    " type='email' placeholder='Enter Email' onChange={handleInput} name='email' />
            ...
            <div className='mx-auto mt-[40px] mb-[30px]' >
              <label class="font-montserrat text-xl text-white font-bold mt-4  flex items-start mb-4" htmlFor="password">password</label>
              <input class=" border font-montserrat placeholder:text-white bg-white bg-opacity-25 border-white focus:border-white
    focus:outline-white focus:bg-opacity-35  text-white rounded-3xl py-2 pl-6 pr-20 h-10 w-400   
    " type='password' placeholder='Enter password' onChange={handleInput} name='password' />
              {/* {errors.password && <span>{errors.password}</span>} */}
            </div>  
            <div class="flex justify-center items-center">
            <button class="font-montserrat text-xl text-white mx-auto
